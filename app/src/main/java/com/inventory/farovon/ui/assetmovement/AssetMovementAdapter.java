...
public class AssetMovementAdapter extends RecyclerView.Adapter<AssetMovementAdapter.DocumentViewHolder> {

    private final List<AssetMovementDocument> documentList;
    ...
    public AssetMovementAdapter(List<AssetMovementDocument> documentList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull DocumentViewHolder holder, int position) {
        AssetMovementDocument document = documentList.get(position);
    ...
    class DocumentViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final AssetMovementDocument document, final OnItemClickListener listener) {
