...
public class WriteOffAssetsFragment extends Fragment implements ScanModeBottomSheetFragment.ScanModeListener {

    private static final String TAG = "WriteOffAssetsFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_write_off_assets, container, false);
        ...
        // Reusing AssetDetailAdapter as it displays InventoryItemEntity which is what we scan
